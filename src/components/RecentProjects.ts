...
export default function RecentProjects({ repos }: { repos: Repo[] }) {
  return (
    t('div', {
      id: 'RecentProjects',
      className: 'bg-blue-600 w-full md:w-4/5 my-12 pb-4 md:rounded-xl scroll-mt-48 md:scroll-mt-32'
    }, [
        t('h1', { className: 'text-white text-2xl p-8', textContent: 'Recent Projects' }),
