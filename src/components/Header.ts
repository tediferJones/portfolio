...
export default function Header() {
  return (
    ...
    t('div', { className: 'bg-blue-600 text-white w-full flex justify-center sticky top-0 z-20 scroll-mb-0' }, [
        ...
        t('div', { className: 'flex gap-1 sm:gap-6 p-2' }, [
          ...contactMenuToggles.map(key => {
            return LinkTo({
              ...
              className: 'hidden lg:flex gap-2 items-center hover:bg-blue-700 p-4 rounded-xl transition-colors duration-300',
